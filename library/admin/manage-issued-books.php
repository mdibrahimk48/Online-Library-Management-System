...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <center><b><h4 class="header-line">Manage Issued Books</h4></b></center>
    </div>
     <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                          <center><b>Issued Books</b></center> 
                        </div>
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <a href="update-issue-bookdeails.php?rid=<?php echo htmlentities($result->rid);?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> <b>EDIT</b></button> 
