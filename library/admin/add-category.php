...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <center><b><h4 class="header-line">Add category</h4></b></center>
...
<center><button type="submit" name="create" class="btn btn-info"><b>CREATE</b></button></center>
